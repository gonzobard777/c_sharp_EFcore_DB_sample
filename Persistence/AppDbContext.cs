...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().HasData(
            ...
            new() { CompanyId = 3, RoleId = 3, Id = 4, Login = "user023", Name = "Константин", Surname = "Яровой", Email = "kostyaYarovoy@list.ru", EmailConfirmed = true, Phone = "+7(905)789-43-51", IsActive = true }
